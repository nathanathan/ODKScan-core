...
* jni/ -- Everything under this folder are generated by SWIG to Java-to-C++ invocation. [(Has it's own readme)](mScan/jni/README.md)
* TestSuite/ -- TestSuite for tuning the underlying computer vision algorithms. [(Has it's own readmi)](mScan/TestSuite/README.md)
